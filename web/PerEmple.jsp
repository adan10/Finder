        ...
        <div class="inner">
            ...
            <div class="flex ">
                <div style="width: 20%">
                    ...
                    <form align="left">
                        <tr>Tipo de empleo:<input align="left" type="text" name="calle" class="calle" id="calle"  required> <br></tr>
                        <tr>Delegacion:<input type="text" name="dele" class="dele" id="dele" onkeypress="texto();" required> <br></tr>
                        <tr>Horario<input type="text" name="colo" class="colo" id="colo" required onkeypress="return soloNumeros(event)"> <br></tr>
                        <tr>Pago Mensual<input type="text" name="postal" class="postal" id="postal" onkeypress="return soloNumeros(event)" max="5" required> <br></tr>
                        <tr>Link Imagen:<input align="left" type="text" name="calle" class="calle" id="calle"  required> <br></tr>
                        <br>
                        <a  href="#" class="button" >Subir Empleo</a>
